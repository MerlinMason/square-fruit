export const checkAnswer = (
  ...
  if (currentOp === "multiplication" && multiplicationTable !== null) {
    return selectedValues.length === 1 && selectedValues[0] !== undefined && selectedValues[0] * multiplicationTable === target;
  }
  ...
  return currentOp === "subtraction"
    ? Math.abs(val1 - val2) === target
    : val1 + val2 === target;
};
