  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className={cn(
          "relative grow overflow-hidden rounded-full bg-gradient-to-r from-pink-200 via-purple-200 to-blue-200 shadow-inner data-[orientation=horizontal]:h-3 data-[orientation=vertical]:h-full data-[orientation=horizontal]:w-full data-[orientation=vertical]:w-3",
        )}
      >
